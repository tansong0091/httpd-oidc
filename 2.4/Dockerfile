...
RUN apt-get  update\
    && DEBIAN_FRONTEND=noninteractive apt-get install -y apt-utils --allow-unauthenticated libapache2-mod-auth-openidc=2.1.6-1 vim procps gcc g++ make libffi-dev wget\
